...
This version uses smaller looping code, but takes longer to execute.
...
This version uses unrolled direct code to ROL 320 bytes of font bitmap data.  The code is much larger, but executes faster.
