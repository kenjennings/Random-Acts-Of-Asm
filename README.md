...
The only computer I'm aware of that can do scrolling similarly is the Amiga (though, only bit-mapped based the screen display is still controlled by fiddling with a couple pointers in registers rather than actually moving data through screen RAM.)
